...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[4] = { str = "Kill the wolves all in front of you for #DOQUEST'Wolves Across the Border,'# while working your way to the Kobold Vermin located at 47,35 for #DOQUEST'Kobold Camp Cleanup.'#", x = 47, y = 35, zone = "Elwynn Forest" },
			...
			[9] = { str = "Go northwest toward the cave at 47,32. Kill Kobold Workers on the way up to it for #DOQUEST'Investigate Echo Ridge.'#", x = 47, y = 32, zone = "Elwynn Forest" },
			[10] = { str = "Go west to 54,40. Run along south killing the Defias until you finish #DOQUEST'Brotherhood of Thieves.'# Once you're finished, you should be level 4. If not, kill more Defias until you are.", x = 54, y = 40, zone = "Elwynn Forest" },
